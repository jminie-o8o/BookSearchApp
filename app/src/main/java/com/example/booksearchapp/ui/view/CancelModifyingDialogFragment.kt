...
import com.example.booksearchapp.databinding.CancelModifyingFragmentDialogBinding

class CancelModifyingDialogFragment : DialogFragment() {
    private var _binding: CancelModifyingFragmentDialogBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = CancelModifyingFragmentDialogBinding.inflate(inflater, container, false)
        dialog?.window
